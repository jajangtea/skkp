                ...
                <div class="main-box-body clearfix">
                    <div class="form-horizontal">
                        ...
                        if (Yii::app()->user->getLevel() == 3 || Yii::app()->user->getLevel() == 1) {
                            ...
                            echo ' <label class="col-lg-2 control-label">Nilai Skripsi :</label>';
                            echo '<div class="col-lg-10">';
                            echo '<div class="row">';
                            echo '<div class="col-lg-5"> ';
                            echo $form->textField($model,'nilaiSkripsi',array('class' => 'form-control', 'style' => 'width:30%'));
                            echo '</div>';
                            echo ' <div class="col-lg-10">';
                            echo '</div>';
                            echo '</div>';
