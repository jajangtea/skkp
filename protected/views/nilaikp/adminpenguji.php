    ...
    <div class="col-lg-12">
        <div class="main-box clearfix">
            <header class="main-box-header clearfix">
                <h2 class="pull-left"><i class="fa fa-bars"></i> Penilaian Penguji Kerja Praktek</h2> 
            ...
            <div class="main-box-body clearfix">  
                <div class="table-responsive">
                    ...
                    $this->widget('zii.widgets.grid.CGridView', array(
                        ...
                        'dataProvider' => $dataProviderNilaiPengujiKp,
                        //'filter' => $model,
                        'columns' => array(
                            array(
                                'header' => "No",
                          ...
                          array_search($data,$this->grid->dataProvider->getData())+1',
                            ...
                            array(
                               ...
                               // 'value'=>'CHtml::link($data->judul, "http://" . $_SERVER["SERVER_NAME"] . Yii::app()->request->baseUrl . "/file/" . $data->nama_file)',
                                'value'=>'CHtml::link($data["NilaiPenguji"]==null?0:$data["NilaiPenguji"], array("nilaikp/create","NIM"=> $data["NIM"]))',
                            ),
