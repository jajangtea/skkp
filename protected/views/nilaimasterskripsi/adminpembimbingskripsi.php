    ...
    <div class="col-lg-12">
        <div class="main-box clearfix">
            <header class="main-box-header clearfix">
                <h2 class="pull-left"><i class="fa fa-bars"></i> Penilaian Pembimbing Skripsi</h2> 
            ...
            <div class="main-box-body clearfix">  
                <div class="table-responsive">
                    ...
                    $this->widget('zii.widgets.grid.CGridView', array(
                        'id' => 'nilaikp-grid',
                        'dataProvider' => $dataProviderNilaiPembimbingSkripsi,
                        //'filter' => $model,
                        'columns' => array(
                            array(
                                'header' => "No",
                          ...
                          array_search($data,$this->grid->dataProvider->getData())+1',
                            ...
                            array(
                                ...
                                //'headerHtmlOptions' => array('style' => 'display:none'),
                                'htmlOptions' => array('width' => '30%'),
                                'value'=>'CHtml::link($data["Nama"], array("nilaimasterskripsi/update","id"=> $data["IdNMSkripsi"],"idPengajuan"=>$data["idPengajuan"]))',
                            ),
                            array(
                                'type' => 'raw',
                                'header' => 'Judul',
                            ...
                            array(
                               ...
                               // 'value'=>'CHtml::link($data->judul, "http://" . $_SERVER["SERVER_NAME"] . Yii::app()->request->baseUrl . "/file/" . $data->nama_file)',
                                'value'=>'CHtml::link($data["NPembimbing"]== 0 ?0:$data["NPembimbing"], array("nilaimasterskripsi/update","id"=> $data["IdNMSkripsi"],"idPengajuan"=>$data["idPengajuan"]))',
                            ),
