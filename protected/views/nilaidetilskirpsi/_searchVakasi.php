    ...
    <div class="main-box">
        ...
        <div class="main-box-body clearfix">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label class="col-lg-2 control-label">Status Vakasi :</label>
                    <div class="col-lg-10">
                        <div class="row">
                            <div class="col-lg-10">        
                                <?php echo CHtml::activeDropDownList($model, 'statusVakasi', array("Proses"=>"Proses","Lunas"=>"Lunas"), array('prompt' => 'Pilih Status', 'class' => 'form-control')); ?>
                            </div>
                        </div>
                    </div>
                </div>
