        ...
        <div class="main-box-body clearfix">
            <div class="form-horizontal">
                ...
                $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                    ...
                    'source' => $this->createUrl('mahasiswa/suggestpendaftaran'),
                    'htmlOptions' => array(
                        'size' => '40',
                        'style' => 'width:30',
                        'class' => 'form-control',
                ...
                <div class="form-group">
                    <label class="col-lg-2 control-label">Penguji :</label>
                    <div class="col-lg-10">
                        <div class="row">
                            <div class="col-lg-10">      
                                 <?php echo CHtml::activeDropDownList($model, 'idUser', Pendaftaran::model()->getDosenPenguji(), array('prompt' => 'Pilih Penguji', 'class' => 'form-control')); ?>
                            </div>
                        </div>
                    </div>
                </div>
