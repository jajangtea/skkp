 ...
 * @property AsetBarang[] $asetBarangs
 */
class Jenis extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idJenis, namaJenis', 'required'),
			array('idJenis', 'numerical', 'integerOnly'=>true),
			array('namaJenis', 'length', 'max'=>30),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idJenis, namaJenis', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'asetBarangs' => array(self::HAS_MANY, 'AsetBarang', 'idJenis'),
		);
	}
