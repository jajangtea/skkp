 ...
 *
 * The followings are the available columns in table 'prd_jurusan':
...
class Jurusan extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'mahasiswas' => array(self::HAS_MANY, 'Mahasiswa', 'KodeJurusan'),
		);
	}
