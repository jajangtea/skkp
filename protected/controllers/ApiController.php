    ...
    public function actionList() {
        ...
        switch ($model) {
            ...
            case 'user': // {{{ 
                ...
                break; // }}} 
            case 'pengajuan': // {{{ 
                $models = Pengajuan::model()->findAll(array(
                    'with' => array('nIM')));
                break; // }}} 
            default: // {{{ 
...
//        }
    ...
    public function actionPengajuan() {
        ...
        header('Content-type: application/json');
        $sql = "SELECT pp.NIM,pp.Judul,pm.Nama FROM prd_pengajuan pp inner join prd_mahasiswa pm on pp.NIM=pm.NIM";
    ...
    public function actionViewpengajuan($nim) {
        header('Content-type: application/json');
        $sql = "SELECT pp.NIM,pp.Judul,pm.Nama FROM prd_pengajuan pp inner join prd_mahasiswa pm on pp.NIM=pm.NIM WHERE pp.NIM=$nim";
        $data = Yii::app()->db->createCommand($sql)->queryRow();
        $NIM = $data["NIM"];
        $Nama = $data["Nama"];
        $Judul = $data["Judul"];
