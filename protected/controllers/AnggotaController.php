...
class AnggotaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Anggota']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->nomor));
		}
	 ...
	 * @param Anggota $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='anggota-form')
		{
