...
//        Yii::app()->end();
    ...
    public function actionJudul() {
        ...
        $dataPengajuan = Pengajuan::model()->findAll('NIM=:NIM and IDJenisSidan=:IDJenisSidang', array(':NIM' => Yii::app()->user->getUsername(), ':IDJenisSidang' => $this->jenis));
    ...
    function actionListPendaftaran(array $models, $attributeNames) {
