...
class ApiAuth extends CComponent {
	...
	public $userIdentityClass = 'User'; //Only change this value to an Identity Class that extends AUserIdentity.
	public $userIdAttribute = 'id';
	public $usernameAttribute = 'root'; //This value will be set to the useridentity's getName() getter
	public $passwordAttribute = 'toor';
